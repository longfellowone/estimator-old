...
func (ec *executionContext) _Query_node(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalONode2githubᚗcomᚋlongfellowoneᚋestimatorᚋserverᚋestimatorᚋmodelsᚐNode(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalONode2githubᚗcomᚋlongfellowoneᚋestimatorᚋserverᚋestimatorᚋmodelsᚐNode(ctx context.Context, sel ast.SelectionSet, v models.Node) graphql.Marshaler {
